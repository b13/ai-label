...
// Decode ai_origin / reviewed from the ai_metadata JSON column into the edit form,
// since these virtual TCA fields have no real column of their own.
...
// Fold ai_origin / reviewed into the ai_metadata JSON column instead of writing them
// to their own (non-existent) columns. No PSR-14 replacement exists for this yet,
// this hook is still the supported extension point.
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_tcemain.php']['processDatamapClass'][]
    = \B13\AiLabel\Hooks\AiMetaDataHandlerHook::class;

// Renders "reviewed" as a normal checkboxToggle field, without TYPO3 auto-creating a
// real database column for it (that only happens for type=check).
...
// Renders "ai_origin" as a normal selectSingle field, without TYPO3 auto-creating a
// real database column for it (that only happens for type=select).
